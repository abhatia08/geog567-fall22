...
county_aerosol_data <- read_csv("../source_data/GEE_output/MCD_Aerosol_Optical_Depth_11032022.csv")
...
merged_data_full$upd_geoid <- paste0("0", as.character(merged_data_full$GEOID))
merged_data_full <- merged_data_full[,2:7]
write_csv(merged_data_full, "GEE_county_data_11082022.csv")
